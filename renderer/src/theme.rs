...
pub const ICON_SCREEN_FULL: char = '\u{eb4c}'; // codicon "screen-full" — enter fullscreen
pub const ICON_SCREEN_NORMAL: char = '\u{eb4d}'; // codicon "screen-normal" — exit fullscreen
